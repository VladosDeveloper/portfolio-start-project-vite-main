		...
		<S.Footer>
			<Container>
				...
				>
					...
					<S.References>
						<S.SocialLink as={Link} to='works' smooth={true} offset={-100}>Проекты</S.SocialLink>
						<S.SocialLink as={Link} to='contact' smooth={true} offset={-100}>Связаться</S.SocialLink>
					</S.References>
